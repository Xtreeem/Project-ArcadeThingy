...
namespace Project_ArcadeThingy
{
    public class AABBRectangle
    {
        ...
        public AABBRectangle(Rectangle theRectangle, float theInitialRotation)
        {
        ...
        {
            return Intersects(new AABBRectangle(theRectangle, 0.0f));
        }
        ...
        /// <param name="theRectangle"></param>
        /// <returns></returns>
        public bool Intersects(AABBRectangle theRectangle)
        {
        ...
        /// <returns></returns>
        private bool IsAxisCollision(AABBRectangle theRectangle, Vector2 aAxis)
        {
        ...
        public bool Contains(AABBRectangle _OtherRec)
        {
            Vector2 UL = RotatePoint(_OtherRec.UpperLeftCorner(), new Vector2(CollisionRectangle.Center.X, CollisionRectangle.Center.Y), -Rotation);
            Vector2 UR = RotatePoint(_OtherRec.UpperRightCorner(), new Vector2(CollisionRectangle.Center.X, CollisionRectangle.Center.Y), -Rotation);
            Vector2 LL = RotatePoint(_OtherRec.LowerLeftCorner(), new Vector2(CollisionRectangle.Center.X, CollisionRectangle.Center.Y), -Rotation);
            Vector2 LR = RotatePoint(_OtherRec.LowerRightCorner(), new Vector2(CollisionRectangle.Center.X, CollisionRectangle.Center.Y), -Rotation);
            return (
                (CollisionRectangle.Contains((int)UL.X, (int)UL.Y)) &&
                (CollisionRectangle.Contains((int)UR.X, (int)UR.Y)) &&
                (CollisionRectangle.Contains((int)LL.X, (int)LL.Y)) &&
                (CollisionRectangle.Contains((int)LR.X, (int)LR.Y))
                );
        }
        public bool Contains(Rectangle OtherRec)
        {
            return Contains(new AABBRectangle(OtherRec, 0));
        }
        ...
        {
            Vector2 T = RotatePoint(_Point, new Vector2(CollisionRectangle.Center.X, CollisionRectangle.Center.Y), -Rotation);
            return CollisionRectangle.Contains((int)T.X, (int)T.Y);
        }
        ...
        public bool Debug(AABBRectangle _OtherRec)
        {
            Vector2 UL = RotatePoint(_OtherRec.UpperLeftCorner(), new Vector2(CollisionRectangle.Center.X, CollisionRectangle.Center.Y), -Rotation);
            Vector2 UR = RotatePoint(_OtherRec.UpperRightCorner(), new Vector2(CollisionRectangle.Center.X, CollisionRectangle.Center.Y), -Rotation);
            Vector2 LL = RotatePoint(_OtherRec.LowerLeftCorner(), new Vector2(CollisionRectangle.Center.X, CollisionRectangle.Center.Y), -Rotation);
