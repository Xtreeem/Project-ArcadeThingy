...
namespace Project_ArcadeThingy
{
    ...
    {
        public SideScrollingPlayerCharacter(Vector2 _Size, Vector2 _Position,ref World _World, Controller _Controller) : base(_Size, _Position,ref _World, _Controller)
        {
